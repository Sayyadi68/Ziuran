...
const navliks = [{ id: 1, text: '', link: '', icon: '', desc: '' }]
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 bg-white shadow-lg rounded-lg p-4'>
        <div>
          ...
          <p className='mb-3 flex flex-row gap-2'>
            <FaPhone className='text-[#FF4D6D] text-md' />
            تلفن:09123456789{' '}
          </p>
          <p className='mb-3 flex flex-row gap-2'>
            <FaMailBulk className='text-[#FF4D6D] text-md' />
            ایمیل: info@example.com
          </p>
          <p className='mb-3 flex flex-row gap-2'>
            <FaThumbtack className='text-[#FF4D6D] text-md' />
            آدرس: تهران، خیابان ولیعصر، کوچه طراحان{' '}
          </p>
        </div>
        <div>
          <h3 className='text-[#000] text-xl font-extrabold font-[BYekan] mb-2'>
