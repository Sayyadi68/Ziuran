...
const PhoneHeader = () => {  
  ...
  return (  
    <>  
      <div className="navbar bg-base-100" ref={componentRef}>  
        <div className="navbar-start">  
          <div className="dropdown">  
            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle" onClick={handleShow}>  
              <svg  
      ...
      {showPhoneMenu && <PhoneMenu className="block z-50" />}  
    </>  
  );  
};  
